...
| drone_lib | [src/drone_lib/src/motion_policy.cpp:24](src/drone_lib/src/motion_policy.cpp#L24) | MotionPolicy::irPara() -> irPara |
| drone_lib | [src/drone_lib/src/motion_policy.cpp:38](src/drone_lib/src/motion_policy.cpp#L38) | MotionPolicy::irPara() -> setLocalPosition |
| drone_lib | [src/drone_lib/src/motion_policy.cpp:51](src/drone_lib/src/motion_policy.cpp#L51) | MotionPolicy::parar() -> setLocalPosition |
...
| stdstates | [src/stdstates/include/stdstates/goto_state.hpp:56](src/stdstates/include/stdstates/goto_state.hpp#L56) | act() -> setLocalVelocity |
| stdstates | [src/stdstates/include/stdstates/goto_state.hpp:63](src/stdstates/include/stdstates/goto_state.hpp#L63) | act() -> irPara |
...
| stdstates | [src/stdstates/include/stdstates/landing/estrategia.hpp:70](src/stdstates/include/stdstates/landing/estrategia.hpp#L70) | encerrar() -> setLocalVelocity |
| stdstates | [src/stdstates/include/stdstates/landing/exponencial.hpp:105](src/stdstates/include/stdstates/landing/exponencial.hpp#L105) | passo() -> setLocalVelocity |
| stdstates | [src/stdstates/include/stdstates/landing/exponencial.hpp:114](src/stdstates/include/stdstates/landing/exponencial.hpp#L114) | passo() -> setLocalVelocity |
| stdstates | [src/stdstates/include/stdstates/landing/px4_land.hpp:65](src/stdstates/include/stdstates/landing/px4_land.hpp#L65) | preparar() -> land |
| stdstates | [src/stdstates/include/stdstates/landing/px4_land.hpp:91](src/stdstates/include/stdstates/landing/px4_land.hpp#L91) | passo() -> disarm |
| stdstates | [src/stdstates/include/stdstates/landing/s_curve.hpp:92](src/stdstates/include/stdstates/landing/s_curve.hpp#L92) | passo() -> setLocalVelocity |
| stdstates | [src/stdstates/include/stdstates/landing/s_curve.hpp:106](src/stdstates/include/stdstates/landing/s_curve.hpp#L106) | passo() -> setLocalVelocity |
| stdstates | [src/stdstates/include/stdstates/next_waypoints.hpp:104](src/stdstates/include/stdstates/next_waypoints.hpp#L104) | navigate() -> setLocalVelocity |
| stdstates | [src/stdstates/include/stdstates/next_waypoints.hpp:119](src/stdstates/include/stdstates/next_waypoints.hpp#L119) | navigate() -> irPara |
...
| stdstates | [src/stdstates/include/stdstates/return_home_state.hpp:121](src/stdstates/include/stdstates/return_home_state.hpp#L121) | act() -> setLocalVelocity |
| stdstates | [src/stdstates/include/stdstates/return_home_state.hpp:142](src/stdstates/include/stdstates/return_home_state.hpp#L142) | act() -> irPara |
| stdstates | [src/stdstates/include/stdstates/return_home_state.hpp:149](src/stdstates/include/stdstates/return_home_state.hpp#L149) | act() -> setLocalVelocity |
| stdstates | [src/stdstates/include/stdstates/return_home_state.hpp:153](src/stdstates/include/stdstates/return_home_state.hpp#L153) | act() -> irPara |
...
| `fase1_node.grid_step_x` | -1.5 | 2.0 |
| `fase1_node.grid_y_length` | -5.5 | -6.0 |
...
| `fase3_node.takeoff_height` | -1.8 | -1.15 |
